package de.unibi.agbi.biodwh2.reactome.entities.ReferenceEntity.ReferenceSequence.ReferenceGeneProduct;
...
public class ReferenceGeneProduct extends ReferenceSequence {
    ...
    @Relationship(type = "referenceTranscript", direction = Relationship.INCOMING)
