...
public class ReactomeModel {
    public static Class[] entitylist = {
            ...
            Complex.class, OtherEntity.class, Polymer.class, SimpleEntity.class, Book.class, LiteratureReference.class,
            URL.class, ReferenceGeneProduct.class, ReferenceIsoform.class, ReferenceDNASequence.class,
